        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">                          
                    ...
                    <div class="card-body">
                        <form method="POST" action="cuponsadm.php" ><!----------------------------------------Formulario--------------------------------->
                        <div class="row">
                            <div class="col-md-2 pr-1">
                                <div class="form-group">
                                    <label>Código</label>
                                    <input type="number" class="form-control" name="cod_cupom">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 pl-1">
                                <div class="form-group">
                                    <label>Nome</label>
                                    <input type="text" class="form-control" name="nome_cupom">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 pl-1">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="preco_cupom">
                                </div>
                            </div>
                        </div>
