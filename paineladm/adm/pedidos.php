                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-body all-icons">
                            <form method="POST" action="excluirpedido.php"><!--------------------------------------------Formulario--------------------------------->
                                <div class="row">
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group">
                                            <label>Codigo</label>
                                            <input type="text" class="form-control" name="cod_pedido">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md- pl-2">
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-primary" name="botao"  value="consultar"></input>
